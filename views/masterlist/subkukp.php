            ...
            <div class="card-body">
                ...
                <div class="masterlist-pero-form">
                    ...
                    <div class="row">
                        ...
                        <?= $form->field($model, 'perakuan_subkukp')->dropDownList(
                            ArrayHelper::map(\app\models\KonfRujukan::getAllRujukanByFlag('perakuan_subkukp'), 'id', 'rujukanNama'),
                        ...
                        <?= $form->field($model, 'catatan_subkukp')->textarea([
                                'rows' => 6,
                                'required' => true,
                                'options' => [
                                    'validateOnSubmit' => true,
