            ...
            <div class="card-body">
                ...
                <div class="masterlist-pero-form">
                    ...
                    <div class="row">
                        ...
                        <?= $form->field($model, 'perakuan_ksu')->dropDownList(
                            ArrayHelper::map(\app\models\KonfRujukan::getAllRujukanByFlag('perakuan_ksu'), 'id', 'rujukanNama'),
                        ...
                        <?= $form->field($model, 'catatan_ksu')->textarea([
                            'rows' => 6,
                            'required' => true,
                            'options' => [
                                'validateOnSubmit' => true,
